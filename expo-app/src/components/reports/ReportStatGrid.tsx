...
import type { ReportStat } from '../../types/domain';

export interface ReportStatGridProps {
  stats: ReportStat[];
}

export const ReportStatGrid = memo<ReportStatGridProps>(({ stats }) => {
...
ReportStatGrid.displayName = 'ReportStatGrid';
